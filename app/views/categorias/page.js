...
export default function Categorias() {
  ...
  const toggleBookmark = async (producto) => {
    ...
    // Verificar si ya está en favoritos antes de intentar agregarlo
    if (isAdding && isBookmarked[producto.idProducto]) {
        Swal.fire({
            toast: true,
            position: "bottom-end",
            icon: "info",
    ...
    try {
        if (isAdding) {
            ...
            // Aquí se debería utilizar el `idFavorito` para eliminar correctamente
