    ...
    <div className={styles.container}>
      <div className={styles.profileWrapper}>
        ...
        <div className={styles.menu2}>
          ...
          <div className={styles.menuItemLog} onClick={handleLogoutClick}>
            <span className={styles.icon}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-box2-heart" viewBox="0 0 16 16">
            <path d="M8 7.982C9.664 6.309 13.825 9.236 8 13 2.175 9.236 6.336 6.31 8 7.982"/>
              <path d="M3.75 0a1 1 0 0 0-.8.4L.1 4.2a.5.5 0 0 0-.1.3V15a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V4.5a.5.5 0 0 0-.1-.3L13.05.4a1 1 0 0 0-.8-.4zm0 1H7.5v3h-6zM8.5 4V1h3.75l2.25 3zM15 5v10H1V5z"/>
        ...
        {showLogoutModal && (
          <div className={styles.modalBackdrop} onClick={cancelLogout}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              <h2 className={styles.h2}>¿Seguro que quiere cerrar sesion?</h2>
              
              <div className={styles.modalButtons}>
                <button onClick={cancelLogout} className={styles.cancelButton}>Cancelar</button>
                <button onClick={confirmLogout} className={styles.confirmButton}><Link href="../views/iniciar_Sesion" > Confirmar </Link></button>
              </div>
            </div>
          </div>
        )}
